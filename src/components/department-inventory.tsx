                  ...
                  <TableCell className="w-[120px] text-center align-middle">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <Input
                        ...
                        pattern="[0-9.,]*"
                        variant="bordered"
                        style={{ minWidth: '1.4em', maxWidth: '3.2em', width: `calc(${Math.max(1.4, Math.min(3.2, String(inputValues[item.id] ?? '').length * 1.1))}em + 2px)`, textAlign: 'center', fontWeight: 600, textAlignLast: 'center' }}
